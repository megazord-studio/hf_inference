...
INTENTS: List[Intent] = [
    ...
    Intent(id="describe-image", label="Image Captioning", description="Generate a description of an image", input_types=["image"], hf_tasks=["image-to-text", "image-text-to-text"]),
    ...
    Intent(id="vision-language", label="Vision+Language Reasoning", description="Combine image and text for reasoning", input_types=["image", "text", "multimodal"], hf_tasks=["image-text-to-text"]),
]
