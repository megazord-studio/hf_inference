...
from app.helpers import device_arg, audio_to_bytes
...
def run_text_to_audio(spec, dev: str):
    ...
    try:
        ...
        if is_gated_repo_error(e):
            return {"skipped": True, "reason": "gated model (no access/auth)", "hint": "Try facebook/musicgen-*"}
        if is_missing_model_error(e) or is_no_weight_files_error(e):
            return {"skipped": True, "reason": "model not loadable (missing/unsupported weights)", "hint": "Try facebook/musicgen-*"}
