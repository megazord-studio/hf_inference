...
from app.utilities import is_cuda_oom, is_gated_repo_error, is_missing_model_error, soft_skip
...
def run_text2text(spec, dev: str):
    try:
        ...
        safe_print_output({"error": "text2text-generation failed", "reason": repr(e)})
