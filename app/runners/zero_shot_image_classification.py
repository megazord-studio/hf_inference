...
def run_zero_shot_image_classification(spec, dev: str):
    ...
    try:
        ...
        if is_missing_model_error(e):
            return {"skipped": True, "reason": "model not found on Hugging Face", "hint": "Use openai/clip-vit-base-patch32 or laion/CLIP-ViT-H-14."}
        return {"error": "zero-shot-image-classification failed", "reason": repr(e)}
