"""Main ImageTextToText runner - routes to appropriate arch handlers.

This is the main entry point for multimodal inference. The runner:
1. Detects model architecture on load
2. Delegates to appropriate loader
3. Routes predictions to appropriate predictor
"""
...
class ImageTextToTextRunner(BaseRunner):
    ...
    def __init__(self, model_id: str, device: Any, dtype: str = None):
    ...
    def _load_by_arch(self) -> int:
        ...
        loader = loaders.get(self._arch, self._load_generic_vqa)
        return loader()
    ...
    def _predict_by_arch(
        ...
        predictor = predictors.get(self._arch, lambda: {})
        return predictor()
