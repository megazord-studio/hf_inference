...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("deepset/xlm-roberta-base-squad2", {"qa_question": "What does SBB refer to?", "qa_context": "SBB is the national railway company of Switzerland."}),
...
def test_question_answering(client, model_id, payload):
    spec = create_spec(model_id=model_id, task="question-answering", payload=payload)
