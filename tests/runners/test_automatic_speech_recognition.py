...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("facebook/wav2vec2-large-960h-lv60-self", {"audio_path": "audio.wav"}),
        ("jonatasgrosman/wav2vec2-large-xlsr-53-english", {"audio_path": "audio.wav"}),
    ],
)
def test_automatic_speech_recognition(client, sample_audio, model_id, payload):
    spec = create_spec(model_id=model_id, task="automatic-speech-recognition", payload={})
