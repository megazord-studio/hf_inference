...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("facebook/mask2former-swin-base-coco-panoptic", {"image_path": "image.jpg"}),
        ("nvidia/segformer-b0-finetuned-ade-512-512", {"image_path": "image.jpg"}),
        ("facebook/mask2former-swin-large-coco-panoptic", {"image_path": "image.jpg"}),
        ("nvidia/segformer-b3-finetuned-ade-512-512", {"image_path": "image.jpg"}),
    ],
)
def test_image_segmentation(client, sample_image, model_id, payload):
    spec = create_spec(model_id=model_id, task="image-segmentation", payload={})
