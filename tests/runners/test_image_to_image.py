...
@pytest.mark.parametrize(
    "model_id,payload",
    [
        ("runwayml/stable-diffusion-inpainting", {"init_image_path": "image.jpg", "prompt": "Make the sky sunset orange."}),
        ("stabilityai/stable-diffusion-2-inpainting", {"init_image_path": "image.jpg", "prompt": "Turn the chairs red."}),
    ],
)
