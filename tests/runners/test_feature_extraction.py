...
@pytest.mark.parametrize(
    "model_id,payload",
    [
        ("sentence-transformers/all-MiniLM-L6-v2", {"prompt": "This is a short sentence."}),
        ("sentence-transformers/paraphrase-MiniLM-L6-v2", {"prompt": "This is a short sentence."}),
...
def test_feature_extraction(client, model_id, payload):
    spec = create_spec(model_id=model_id, task="feature-extraction", payload=payload)
