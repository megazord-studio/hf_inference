...
PARAMS = [
    ("/api/inference/stream", {"model_id": "gpt2", "prompt": "Hello", "max_new_tokens": 5}, ["event: start", "event: token", "event: done"]),
    ("/api/inference/stream/text-to-image", {"model_id": "ehristoforu/stable-diffusion-v1-5-tiny", "prompt": "a tiny cat", "num_inference_steps": 4}, ["event: start", "event: progress", "event: done"]),
]
