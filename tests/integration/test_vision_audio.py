...
PARAMS = [
    ...
    ("superb/wav2vec2-base-superb-ks", 'audio-classification', 'audio', {'audio_base64': None}, 'predictions'),
    ...
    ("Intel/dpt-hybrid-midas", 'depth-estimation', 'image', {'image_base64': None}, 'depth_summary'),
]
...
def test_vision_audio_parametrized(client, model_id, task, input_type, inputs, expected):
